...
public class F21RotatedHybridComposition3 extends TestFunc {
    ...
    // Constructors
    public F21RotatedHybridComposition3(int dimension, double bias) throws JMetalException {
        this(dimension, bias, DEFAULT_FILE_DATA,
                DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
    }

    public F21RotatedHybridComposition3(int dimension, double bias, String file_data, String file_m) throws
            JMetalException {
