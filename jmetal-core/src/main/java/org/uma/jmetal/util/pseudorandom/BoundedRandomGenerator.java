...
public interface BoundedRandomGenerator<Value extends Comparable<Value>> extends Serializable {
     ...
     *
     * @param doubleGenerator {@link BoundedRandomGenerator} which generates {@link Double}
     *                        values
     ...
     *
     * @param doubleGenerator {@link RandomGenerator} which generates {@link Double} values
     * @return {@link BoundedRandomGenerator} which generates {@link Integer}
     * values based on the provided generator
     */
     ...
     *
     * @param unboundedGenerator {@link RandomGenerator} which generates values between 0 and 1
