 ...
 *
 * <p>Each line of the file represents a solution. The format of each of these solutions is rather
 ...
 * separated by blank spaces, tabs, or commas (cvs)
 *
 * <p>The program receives three parameters: 1. the name of the file containing the data 2. the
 * output file name which will contain the generated front 3. the number of objectives
 */
